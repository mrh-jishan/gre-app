...
class VocabulariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vocabulary" do
    assert_difference('Vocabulary.count') do
      post vocabularies_url, params: { vocabulary: { base_word: @vocabulary.base_word, description: @vocabulary.description, synonym: @vocabulary.synonym, translation: @vocabulary.translation, vocabulary_sets_id: @vocabulary.vocabulary_sets_id } }
    end
  ...
  test "should update vocabulary" do
    patch vocabulary_url(@vocabulary), params: { vocabulary: { base_word: @vocabulary.base_word, description: @vocabulary.description, synonym: @vocabulary.synonym, translation: @vocabulary.translation, vocabulary_sets_id: @vocabulary.vocabulary_sets_id } }
